...
const AppRoutes = () => {
  ...
  const deepLinkVideoData = useRef(null);
  ...
  useEffect(() => {
    ...
    let hlsUrl = params.get('hls_url');
    if (hlsUrl) {
      hlsUrl = decodeURIComponent(hlsUrl);
      // Remove extra quotes if present
      deepLinkVideoData.current = hlsUrl.replace(/^"|"$/g, '');
      setIsDeepLink(true);
    }
  }, []);
        ...
        <VizioInfoProvider>
          <Suspense>
            <Home
              ...
              deepLinkVideoData={deepLinkVideoData.current}
