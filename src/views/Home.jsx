...
const Home = ({
  ...
  const handleDeepLinkPlayerClose = () => {
    if (setIsDeepLink) {
      setIsDeepLink(false);
    }
  ...
  return (
    <>
      ...
      <Main>
        ...
        {isDeepLink && (
          <Suspense fallback={<Loading size={80} showText={false} />}>
            <Player
              id="player"
              videoData={deepLinkVideoData}
              resumeFrom={0}
              handlePlayerClose={handleDeepLinkPlayerClose}
              setShowDetailPage={() => { }}
              isTrailer={false}
              isDeepLink
            />
...
Home.propTypes = {
  ...
  deepLinkVideoData: PropTypes.string,
  setIsDeepLink: PropTypes.func.isRequired,
};
